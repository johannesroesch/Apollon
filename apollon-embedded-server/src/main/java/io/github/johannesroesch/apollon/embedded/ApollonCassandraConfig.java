...
public class ApollonCassandraConfig implements ConfigurationLoader {
    ...
    public Config loadConfig() {
        ...
        config.server_encryption_options = new EncryptionOptions.ServerEncryptionOptions("conf/.keystore", "cassandra", "conf/.truststore", "cassandra", null, null, null, null, "JKS", false, false, null, EncryptionOptions.ServerEncryptionOptions.InternodeEncryption.none, false);

        config.client_encryption_options = new EncryptionOptions("conf/.keystore", "cassandra", "conf/.truststore", "cassandra", null, null, null, null, "JKS", false, false, null, null);
